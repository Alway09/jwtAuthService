...
public class TestData {
    ...
    public static final String CLIENT1_LOGIN = "valentine";
    public static final String CLIENT3_LOGIN = "disabledclient";
    public static final String CLIENT_NEW_LOGIN = "string";

    public static final Client CLIENT1 = new Client(CLIENT1_ID, CLIENT1_LOGIN, "{bcrypt}$2a$10$SaDBEsf8xdO9YBu/g27Zde2C5xDVePV.HX3a1aihq958WtwCL0B1S");
    ...
    public static final Client CLIENT3 = new Client(CLIENT3_ID, CLIENT3_LOGIN, "{bcrypt}$2a$10$t0lnFAcnNuJngWH/jJr1CepRENoUkCzROBrPYp/ZvHc13MdlXV38.");
    public static final Client CLIENT_NEW = new Client(CLIENT_NEW_ID, CLIENT_NEW_LOGIN, "{bcrypt}12121212");
